...
path = '/home/damu/Downloads/srt/en_0001_nagarajaprakasam/'
err_folder = "/home/damu/ISRL/English_MS/errors/"
# text_file_folder = "/home/damu/ISRL/English_MS/segmented_text_files/"
outputFile = open("/home/damu/ISRL/English_MS/database.txt","w")

audioMetadata = {}
actualAudioDurations = open("/home/damu/ISRL/English_MS/audio_length.txt","r")
...
for file in fileList:
    ...
    fileDuration = (datetime.strptime(actualDuration, '%H:%M:%S') - datetime.strptime("00:00:00", '%H:%M:%S')).seconds
    print(file)
    c = 1
    ...
    totalDuration = totalDuration + timedelta(seconds=fileDuration)
outputFile.close()
